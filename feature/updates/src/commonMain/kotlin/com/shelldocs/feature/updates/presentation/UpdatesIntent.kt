...
sealed interface UpdatesIntent : MviIntent {
    ...
    data class ApplyMetadataAssignments(val documentId: String, val assignments: List<MetadataAssignment>) :
        UpdatesIntent
    ...
    data class OpenDocument(val documentId: String) : UpdatesIntent
}
